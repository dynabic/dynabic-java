...
public class DynabicmarketingplansAPI extends Object {
	 ...
	 */
	 ...
	 public static SetActiveMarketingPlanResponse SetActiveMarketingPlan(String productId) throws APIException {

		//parse inputs
		String  resourcePath = "/dynabicmarketingplans/activate/{productId}";
		...
		SetActiveMarketingPlanResponse responseObject = (SetActiveMarketingPlanResponse) getApiInvoker().deserialize(response, SetActiveMarketingPlanResponse.class);
